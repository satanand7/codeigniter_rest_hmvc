...
class APN {
     ...
     * @return <string>
     */
    protected function generatePayload($message, $badge = NULL, $sound = NULL, $newstand = false, $extra = false) {
     ...
     * @param <string> $sound
     */
    public function sendMessage($deviceToken, $message, $badge = NULL, $sound = NULL, $expiry = '', $newstand = false, $extra = false) {
        $this->error = '';
       ...
       // log_message('info', "APN: sendMessage '$message' to $deviceToken");
        ...
        $payload = $this->generatePayload($message, $badge, $sound, $newstand, $extra);
        //var_dump($payload);
       // die;
